...
# Cores ANSI por protocolo
CORES = {
    "TCP":   "\033[94m",   # azul claro
    "UDP":   "\033[92m",   # verde
    "DNS":   "\033[93m",   # amarelo
    "mDNS":  "\033[96m",   # ciano claro
    "HTTP":  "\033[95m",   # magenta claro
    "HTTPS": "\033[35m",   # magenta
    "FTP":   "\033[91m",   # vermelho claro
    "ARP":   "\033[33m",   # laranja
    "ICMP":  "\033[31m",   # vermelho
    "NTP":   "\033[36m",   # ciano
    "DHCP":  "\033[34m",   # azul
    "IPv4":  "\033[37m",   # branco/cinzento
    "IPv6":  "\033[90m",   # cinzento escuro
    "?":     "\033[2m",    # dimmed
}
RESET = "\033[0m"
BOLD  = "\033[1m"
...
try:
    ...
    if total_pacotes > 0:
        ...
        for proto, quantidade in estatisticas.most_common():
            ...
            print(f"  {cor}{BOLD}- {proto:<8}{RESET}{cor}: {quantidade:>5} pacotes ({percentagem:>5.1f}%){RESET}")
    print("="*45 + "\n")